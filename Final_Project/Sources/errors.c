...
static Error errors[] = {
    ...
    {ERR_CODE_15, "The address is out of range."},
    {ERR_CODE_16, "Comma in the wrong place."},
    {ERR_CODE_17, "There is more commas than needed."},
    {ERR_CODE_18, "Missing '\"' after '.string'."},
    {ERR_CODE_19, "Missing '\"' at the end of '.string' line."},
    {ERR_CODE_20, "Instruction does not exist."},
    {ERR_CODE_21, "Invalid label name, does not start with a letter."},
    {ERR_CODE_22, "Invalid labal name, there is an unauthorized character."},
    {ERR_CODE_23, "Invalid label name, longer than 31 characters."},
    {ERR_CODE_24, "Invalid label name, identical to an instruction name."},
    {ERR_CODE_25, "Invalid lable name, identical to an mcro name."},
    {ERR_CODE_26, "Invalid label name, identical to an reserved word."},
    {ERR_CODE_27, "Invalid label definition, there is ' ' between label name and ':'."},
    {ERR_CODE_28, "Invalid label definition, missing ':' after label name."},
